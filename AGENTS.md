...
- Le configurazioni applicative sono raccolte in `BookStoreApp.API/Configurations/` (AutoMapper, JWT, Identity, CORS). Modifica le estensioni lì per aggiungere policy/servizi invece di appesantire `Program.cs`.
